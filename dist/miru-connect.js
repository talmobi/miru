...
},{"./debug":12,"_process":42}],12:[function(require,module,exports){
...
},{"ms":39}],13:[function(require,module,exports){
...
},{"./transport":15,"./transports/index":16,"component-emitter":9,"debug":22,"engine.io-parser":24,"indexof":38,"parseqs":40,"parseuri":41}],15:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":10,"debug":22,"engine.io-parser":24,"parseqs":40,"xmlhttprequest-ssl":21,"yeast":54}],20:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":10,"debug":22,"engine.io-parser":24,"parseqs":40,"ws":7,"yeast":54}],21:[function(require,module,exports){
(function (global){
...
},{"has-cors":37}],22:[function(require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"./debug":23,"_process":42,"dup":11}],23:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"dup":12,"ms":39}],24:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./keys":25,"./utf8":26,"after":1,"arraybuffer.slice":3,"base64-arraybuffer":5,"blob":6,"has-binary2":35}],25:[function(require,module,exports){
...
},{"./manager":45,"./socket":47,"./url":48,"debug":11,"socket.io-parser":50}],45:[function(require,module,exports){
...
},{"./on":46,"./socket":47,"backo2":4,"component-bind":8,"component-emitter":9,"debug":11,"engine.io-client":13,"indexof":38,"socket.io-parser":50}],46:[function(require,module,exports){
...
},{"./on":46,"component-bind":8,"component-emitter":9,"debug":11,"parseqs":40,"socket.io-parser":50,"to-array":53}],48:[function(require,module,exports){
(function (global){
...
},{"debug":11,"parseuri":41}],49:[function(require,module,exports){
(function (global){
/*global Blob,File*/
...
},{"./binary":49,"./is-buffer":51,"component-emitter":9,"debug":11,"has-binary2":35}],51:[function(require,module,exports){
(function (global){
...
},{"_process":42}],57:[function(require,module,exports){
'use strict';
...
var _stripAnsi = require('./strip-ansi.js');

var _stripAnsi2 = _interopRequireDefault(_stripAnsi);

var _matchesTargets = require('./matches-targets.js');

var _matchesTargets2 = _interopRequireDefault(_matchesTargets);

var _domGetFile = require('./dom-get-file.js');

var _domGetFile2 = _interopRequireDefault(_domGetFile);
...
},{"./ansi-to-html.js":55,"./dom-get-file.js":59,"./matches-targets.js":61,"./modal.js":62,"./strip-ansi.js":67,"./uid.js":68}],58:[function(require,module,exports){
'use strict';
...
window.addEventListener('error', function (domError) {
  ...
  (0, _domGetFile2.default)(filename, function (err, text) {
    if (err) {
      return console.log('[miru] file get error: ' + err);
    }

    if (!(0, _matchesTargets2.default)(filename)) {
    ...
    var errorId = (0, _uid2.default)();

    attempt();
    function attempt() {
      if (attemptsCount % 10 === 0) {
        window.__miru.debug('[miru] [' + errorId + '] ' + 'attempting to woosterify, attempts: ' + attemptsCount);
      }
      attemptsCount++;
      ...
      if (window.__miru.socket) {
        ...
        window.__miru.socket.emit('woosterify', errorId, {
          ...
          if (!done) {
            ...
            var html = (0, _stripAnsi2.default)((0, _ansiToHtml2.default)(data.message));
            ...
            if (data.origin) {
              messages.push({
                name: '(' + filename + ')',
                text: (0, _stripAnsi2.default)((0, _ansiToHtml2.default)(data.origin))
              });
            }

            var basename = filename.split('/').filter(function (f) {
              return f.trim();
            }).pop();
...
},{"./ansi-to-html.js":55,"./dom-get-file.js":59,"./matches-targets.js":61,"./modal.js":62,"./strip-ansi.js":67,"./uid.js":68}],59:[function(require,module,exports){
'use strict';
...
require('./dom-error-watcher.js');

require('./dom-console-watcher.js');
...
},{"./ansi-to-html.js":55,"./dom-console-watcher.js":57,"./dom-error-watcher.js":58,"./net.js":63,"./pesticide.js":64,"./polyfills.js":65,"./uid.js":68}],61:[function(require,module,exports){
'use strict';
 ...
 */
function matchesTarget(filename) {
...
function Message() {
  var _el = (0, _redom.el)('.__miru-error-modal__text', {
    style: {
      'line-height': '1.5em',
      'opacity': 1,
      'white-space': 'pre',
...
function Modal() {
  ...
  }, '[miru] error modal'), _list = (0, _redom.list)('.__miru-error-modal__list', Message));
  ...
  function update(opts) {
    ...
    if (opts) {
      var title = opts.name || opts.title;
      var messages = opts.messages || opts.message || opts.text || opts;
...
},{"redom":43}],63:[function(require,module,exports){
'use strict';
...
console.log('[miru] socket connecting to: ' + _config.URI);
var socket = (0, _socket2.default)(_config.URI);
...
socket.on('success', function (evt) {
  ...
  var basename = target.split('/').filter(function (f) {
    return f.trim();
  }).pop();
  ...
  var style = [].filter.call(styles, function (el) {
  ...
  if (style) {
    ...
    if (window.__miru.styleFlicker) {
      ...
      */
      ...
      setTimeout(function () {
        style.href = href.split('?')[0] + '?cachebuster=' + Date.now();
  ...
  var script = [].filter.call(scripts, function (el) {
...
function handleError(err) {
  ...
  var html = (0, _stripAnsi2.default)((0, _ansiToHtml2.default)(_text));
  ...
  if (err.target) {
    var basename = err.target.split('/').filter(function (f) {
      return f.trim();
    }).pop();
    console.log('[miru] error.target basename: ' + basename);
    window.__miru.terminalErrors[basename] = fn;
...
},{"./ansi-to-html.js":55,"./config.js":56,"./modal.js":62,"./pesticide.js":64,"./strip-ansi.js":67,"socket.io-client":44}],64:[function(require,module,exports){
'use strict';
...
var PESTICIDE_URL = _config.URI + '/__miru/pesticide.css';
...
},{"./config.js":56,"./storage.js":66}],65:[function(require,module,exports){
'use strict';
