...
overloadAddEventListeners([window, document, document && document.body])
...
r.open('GET', 'http://localhost:4040/__miru/lib/livereload.js?cachebuster=' + now)
r.onerror = function () {
