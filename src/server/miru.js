...
// cli-color is a great terminal text color library, better than chalk IMO
var clc = require( 'cli-color' ) // for colored terminal output
...
var argv = require( 'subarg' )( process.argv.slice( 2 ), {
  ...
  boolean: [
    // disable style reload flicker ( not recommended )
    'noflicker',
